...
const InstructorSection = () => {
  return <section className="py-20 lg:py-32 bg-lavender-pale/30">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
          {/* Image Column */}
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-elevated">
              <img src={instructorImage} alt="ThS. Vũ Kim Khánh - Founder The Human Tree" className="w-full h-auto object-cover" />
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <a href="https://tiktok.com/@vukimkhanh" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-2 pr-4 rounded-xl bg-card shadow-soft hover:shadow-elevated transition-all group">
              ...
              <a href="https://facebook.com/vukimkhanhofficial" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-2 pr-4 rounded-xl bg-card shadow-soft hover:shadow-elevated transition-all group">
            ...
            <div className="grid grid-cols-3 gap-4">
              {stats.map((stat, index) => <div key={index} className="text-center p-4 rounded-2xl bg-card shadow-soft">
