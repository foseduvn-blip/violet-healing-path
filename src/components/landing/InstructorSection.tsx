        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <a href="https://tiktok.com/@vukimkhanh" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 p-3 rounded-xl bg-card shadow-soft hover:shadow-elevated transition-all group">
